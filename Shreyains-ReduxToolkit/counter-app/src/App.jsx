...
import { increment, incrementByAmount, decrement, decrementByAmount, multiplyAsync } from './redux/slices/counterSlice';
  ...
  return (
    <>
      ...
      <div className='text-center flex flex-row justify-evenly mt-5 rounded-xl border-2 border-red-700 p-5'>
        ...
        <button onClick={() => dispatch(multiplyAsync(3))} className='text-red-900 bg-blue-400 border-red-900 border-2 rounded-lg shadow-xl bg-transparent p-5'>
          MultiplyByAmount
        </button>
      </div>
    </>
